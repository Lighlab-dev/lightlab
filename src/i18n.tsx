...
const translations = {
  en: {
    ...
    footer: {
      summary:
        "AI solutions, development systems, and media buying strategies built for performance and clarity.",
    ...
    home: {
      ...
      heroCopy:
        "We build bespoke AI automation, high-performance product engineering, and brand-safe media systems to scale your revenue with absolute clarity.",
      scrollLabel: "Scroll",
      expertiseLabel: "Expertise",
      expertiseTitle: "What we do best",
      expertiseCopy:
        "We specialize in creating digital experiences that combine strategic thinking with creative excellence.",
      ...
      bentoCards: [
        {
          title: "Identity",
          copy: "Visual systems for visionary brands.",
          span: "md:col-span-1",
        },
        {
          title: "Engineering",
          copy: "High-performance headless commerce.",
          span: "md:col-span-2",
        },
        {
          title: "Motion",
          copy: "Interactive storytelling through code.",
          span: "md:col-span-2",
        },
        {
          title: "Scale",
          copy: "Data-driven growth architectures.",
          span: "md:col-span-1",
        },
      ],
      clarity: [
      ...
      servicesSubtitle:
        "Choose one track or combine all three into a single delivery roadmap.",
      serviceTracks: [
        {
          title: "AI Solutions",
      ...
      testimonialsSubtitle:
        "We operate like an internal product team, aligned to outcomes and accountable to performance.",
      testimonials: [
        {
          quote:
            "The automations paid for themselves in the first 45 days. Their team moves like a product studio.",
          name: "Amina Patel",
          role: "COO, Meridian Commerce",
        },
        {
          quote:
            "Lightlab rebuilt our acquisition funnel and our CAC dropped while conversion climbed.",
          name: "Jordan Lee",
      ...
      ctaCopy:
        "Share your goals. We will design a delivery plan that covers automation, development, and paid growth.",
      ctaLabel: "Next Move",
    ...
    services: {
      ...
      subtitle:
        "Premium service tracks for AI automation, high-performance development, and brand-safe media buying.",
      overview: {
        heroEyebrow: "Precision & Scale",
        heroTitleLine1: "Scaling",
        heroTitleLine2: "Engines.",
        heroSubtitle:
          "Three core pillars to build, automate, and accelerate your digital assets.",
        heroImageAlt: "Services overview",
        tracks: [
          {
            title: "AI Solutions",
            description:
              "Custom agentic workflows and intelligent automation layers designed to orchestrate complex operations and accelerate your team's execution velocity.",
            deliverables: [
              "RAG & Knowledge base",
          ...
          },
          {
            title: "Engineering",
            description:
              "High-performance product delivery with luxury-grade UI systems and scalable architecture built for uncompromising growth.",
            deliverables: [
              "SaaS & dashboards",
          ...
          },
          {
            title: "Media Buying",
            description:
              "Brand-safe performance creative and advanced funnel analytics engineered to scale revenue and maximize sustainable ROAS.",
            deliverables: [
              "Meta & Google Ads",
        ...
        ctaCopy:
          "Whether for an AI audit or a full engineering rebuild, we are ready.",
      ...
      items: [
        {
          title: "AI Solutions",
          summary:
            "Agentic workflows, copilots, and automation layers that eliminate friction and unlock execution speed.",
          points: [
        ...
        },
        {
          title: "Development Solutions",
          summary:
            "Modern product engineering with performance, stability, and design in sync from day one.",
          points: [
            "Product strategy",
            "Full-stack builds",
            "Launch and growth",
        ...
        },
        {
          title: "Media Buying",
          summary:
            "Performance media systems blending creative testing, funnel analytics, and optimization loops.",
          points: [
            "Paid social + search",
            "Creative lab",
            "Conversion systems",
    ...
    caseStudies: {
      ...
      subtitle:
        "Selected engagements showing measurable outcomes across automation, product, and media systems.",
      overview: {
        ...
        ctaCopy:
          "We select a few projects per quarter to guarantee excellence in execution.",
        ctaMetaLabel: "Availability",
      ...
      studies: [
        {
          ...
          result: "42% faster fulfillment, 18% lower support load.",
          sector: "Commerce",
        },
        {
          title: "Product Platform Rebuild",
          result: "3x release velocity with a new modular stack.",
          sector: "SaaS",
        },
        {
          title: "Paid Media System",
          result: "30% CAC reduction with multi-channel optimization.",
          sector: "Health",
        },
      ],
      ...
      flowSteps: [
        ...
        "Optimize with weekly reporting",
      ],
    ...
    about: {
      ...
      subtitle:
        "We are a hybrid strategy and execution partner helping luxury brands and tech leaders scale through AI and bespoke engineering.",
      overview: {
        ...
        manifestoLead:
          "We believe technology should multiply human talent, not automate it away.",
        manifestoCopy:
          "Lightlab was born to reconcile high-end luxury aesthetics with the raw power of agentic automation. We do not just build tools; we architect compounding assets.",
        ...
        team: [
          ...
          },
          {
            ...
            image:
              "https://lh3.googleusercontent.com/aida-public/AB6AXuABLLseZ3w1row4yMcDl1gCIMRYkOzbvDCRInKr5PZoKZXsqtqVo0moJg5q_O6iopvPqpUXc2T3UdAU1IRZrkWhTVj_PMytzHooKJb05090DMGyYevWMoaBxYj4sVTm-8g3ME4YuOqGZV_N3QqTQA0glZewL-Xz08yernZKWscLXeYm_NqMcmB4CoONZ5q9D32miypw_hZT8FFQNumyJvX7OqAYNZhmDkaToCSzzdNjZe-dY2qXSs_eFV3uOD_Bk83ENRMucT_hVDQ",
            offset: "",
          },
          {
            name: "Sarah B.",
        ...
        ctaCopy:
          "Whether you are a future collaborator or partner, our door is open to sharp minds.",
        ctaMetaLabel: "Availability",
      ...
      principles: [
        {
          ...
          copy: "Every engagement starts with a clear outcome and the metrics that define success.",
        },
        {
          title: "Crafted execution",
          copy: "Design, engineering, and growth are built together for seamless delivery.",
        },
        {
          title: "Compounding loops",
          copy: "We build systems that improve with every release and campaign.",
        },
      ],
      ...
      teamStack: [
        ...
        "Full-stack product builders",
        "Performance media strategists",
    ...
    contact: {
      ...
      subtitle:
        "Share your vision. We will architect the strategy and assemble the bespoke automation or engineering stack to deliver compounding growth.",
      ...
      faqSubtitle:
        "We keep discovery fast and execution structured so you can move quickly with clarity.",
      faqs: [
        {
    ...
    method: {
      ...
      heroCopy:
        "A rigorous delivery framework designed to turn ambition into predictable growth systems.",
      steps: [
        {
          number: "01",
          title: "Diagnostic",
      ...
      ctaCopy:
        "Every project starts with a conversation. Let us review your current systems.",
  ...
  fr: {
    ...
    footer: {
      summary:
        "Solutions IA, developpement produit et media buying pour une croissance claire et mesurable.",
      servicesTitle: "Services",
    ...
    home: {
      ...
      heroMeta: "Lightlab Studio ©2026",
      heroCopy:
        'Nous concevons l\'automation IA sur mesure, le développement produit haute performance et les systèmes média "brand-safe" pour scaler vos revenus avec clarté.',
      scrollLabel: "Defiler",
      expertiseLabel: "Expertise",
      expertiseTitle: "Ce que nous faisons le mieux",
      expertiseCopy:
        "Nous creons des experiences digitales qui allient strategie claire et excellence creative.",
      serviceLabel: "Service",
      ...
      bentoCards: [
        {
          title: "Identite",
          copy: "Systemes visuels pour marques ambitieuses.",
          span: "md:col-span-1",
        },
        {
          title: "Engineering",
          copy: "Plateformes performantes et scalables.",
          span: "md:col-span-2",
        },
        {
          title: "Motion",
          copy: "Narration interactive par le code.",
          span: "md:col-span-2",
        },
        {
          title: "Scale",
          copy: "Architectures de croissance data-driven.",
          span: "md:col-span-1",
        },
      ],
      clarity: [
      ...
      servicesSubtitle:
        "Choisissez un track ou combinez les trois dans une roadmap unique.",
      serviceTracks: [
        {
          title: "Solutions IA",
      ...
      methodCopy:
        "Un process rigoureux pour que chaque pixel et chaque ligne de code servent la performance.",
      testimonialsTitle: "Preuves concretes",
      testimonialsSubtitle:
        "Nous operons comme une equipe produit interne, alignee aux resultats.",
      testimonials: [
        {
          quote:
            "Les automations se sont rentabilisees en 45 jours. Leur equipe travaille comme un studio produit.",
          name: "Amina Patel",
          role: "COO, Meridian Commerce",
        },
        {
          quote:
            "Lightlab a reconstruit notre funnel et le CAC a baisse pendant que la conversion montait.",
          name: "Jordan Lee",
          role: "VP Growth, Nova Health",
        },
      ],
      ...
      ctaCopy:
        "Partagez vos objectifs. Nous concevons un plan qui couvre automation, dev et media.",
    ...
    services: {
      ...
      subtitle:
        'Tracks premium pour l\'automation IA, le développement haute performance et le media buying "brand-safe".',
      overview: {
        heroEyebrow: "Expertise & Delivery",
        heroTitleLine1: "Nos",
        heroTitleLine2: "Expertises.",
        heroSubtitle:
          "Trois piliers fondamentaux pour construire, automatiser et propulser vos actifs digitaux.",
        heroImageAlt: "Aperçu des services",
        tracks: [
          {
            title: "Solutions IA",
            description:
              "Workflows d'agents sur mesure et couches d'automatisation intelligente conçus pour orchestrer des opérations complexes et accélérer la vitesse d'exécution de vos équipes.",
            deliverables: [
          ...
          },
          {
            title: "Engineering",
            description:
              "Livraison de produits haute performance avec des systèmes UI de luxe et une architecture scalable conçue pour une croissance sans compromis.",
            deliverables: [
              "SaaS & dashboards",
              "Progressive web apps",
              "Design systems",
          ...
          },
          {
            title: "Media Buying",
            description:
              "Créatifs performants brand-safe et analytics de funnel avancés conçus pour scaler les revenus et maximiser un ROAS durable.",
            deliverables: [
              "Meta & Google Ads",
              "Creative strategy",
              "Landing page CRO",
        ...
        ctaCopy:
          "Que ce soit pour un audit IA ou une refonte complete de votre engineering, nous sommes prets.",
      ...
      items: [
        {
          title: "Solutions IA",
          summary:
            "Workflows agents, copilots et automations qui eliminent les frictions.",
          points: [
        ...
        },
        {
          title: "Developpement",
          summary:
            "Engineering moderne avec performance, stabilite et design alignes.",
          points: [
            "Strategie produit",
            "Build full-stack",
            "Lancement + growth",
        ...
        },
        {
          title: "Media Buying",
          summary:
            "Systemes media qui combinent creatifs, analytics et optimisation continue.",
          points: [
            "Paid social + search",
            "Creative lab",
    ...
    caseStudies: {
      ...
      subtitle:
        "Engagements selectionnes avec des resultats mesurables sur automation, produit et media.",
      overview: {
        heroEyebrow: "Portfolio archive",
        ...
        ctaCopy:
          "Nous selectionnons quelques projets par trimestre pour garantir une excellence absolue dans l execution.",
        ctaMetaLabel: "Disponibilite",
      ...
      studies: [
        {
          title: "AI Ops Automation",
          result: "42% plus rapide, 18% moins de support.",
          sector: "Commerce",
        },
        {
          title: "Rebuild plateforme",
          result: "3x vitesse de release avec stack modulaire.",
          sector: "SaaS",
        },
        {
          title: "Systeme media",
          result: "CAC -30% avec optimisation multi-canal.",
          sector: "Health",
        },
      ],
      flowTitle: "De l audit a la croissance",
      flowSteps: [
        "Audit et capture data",
        "System design + roadmap",
        "Build, test, launch",
        "Optimisation hebdo",
      ],
    ...
    about: {
      ...
      subtitle:
        "Partenaire hybride stratégie + exécution pour marques de luxe et leaders tech via l'IA et l'engineering sur mesure.",
      overview: {
        ...
        manifestoLead:
          "Nous croyons que la technologie doit multiplier le talent humain, pas le remplacer.",
        manifestoCopy:
          "Lightlab est né pour réconcilier l'esthétique du luxe avec la puissance brute de l'automatisation agentique. Nous ne construisons pas de simples outils ; nous architecturons des actifs à croissance composée.",
        ...
        ctaTitle: "On discute ?",
        ctaCopy:
          "Que vous soyez un futur collaborateur ou un partenaire, notre porte est ouverte.",
        ctaMetaLabel: "Disponibilite",
      ...
      principles: [
        {
          title: "Clarte strategique",
          copy: "Chaque mission demarre avec des KPIs precis et partages.",
        },
        {
          title: "Execution soignee",
          copy: "Design, engineering et growth construits ensemble.",
        },
        {
          title: "Boucles de progression",
          copy: "Des systemes qui s ameliorent a chaque release.",
        },
      ],
      teamTitle: "Team stack",
      teamSubtitle: "Pods multidisciplinaires",
      teamStack: [
        "Engineers automation IA",
        "Builders full-stack",
        "Strateges media performance",
        "Creative technologists",
      ],
    ...
    projects: {
      ...
      titleLine2: "Prouvés",
      subtitle:
        "Une sélection d'engagements à fort impact couvrant l'automation IA, le développement produit et le scaling des revenus.",
      stats: {
        projects: "Projets",
        awards: "Prix",
        years: "Années",
      ...
      items: [
        {
          title: "Helios Automation Suite",
          focus: "IA + Ops",
          result: "Charge support -22% en 60 jours.",
        },
        {
          title: "Pulse Commerce Build",
          focus: "Developpement",
          result: "3x vitesse de release avec storefront modulaire.",
        },
        {
          title: "Nova Media Engine",
          focus: "Media Buying",
          result: "CAC -28% avec tests multi-canal.",
        },
        {
          title: "Beacon Growth Stack",
          focus: "IA + Media",
          result: "ROAS +32% apres automation.",
        },
      ],
    ...
    contact: {
      ...
      subtitle:
        "Partagez votre vision. Nous architecturerons la stratégie et assemblerons la stack d'automatisation ou d'engineering sur mesure pour livrer une croissance composée.",
      ...
      faqSubtitle:
        "Discovery rapide et execution structuree pour avancer avec clarte.",
      faqs: [
        {
    ...
    method: {
      ...
      heroCopy:
        "Un cadre de travail rigoureux concu pour transformer l ambition en systemes de croissance previsibles.",
      steps: [
        {
          number: "01",
          title: "Diagnostic",
          ...
          deliverables: [
            "Audit des processus IA",
            "Analyse de la tech stack",
        ...
        },
        {
          ...
          deliverables: [
            ...
            "Schema d architecture IA",
            "Prototype basse fidelite",
          ],
          metaLabel: "Duree",
        ...
        },
        {
          ...
          deliverablesLabel: "Livrables",
          deliverables: [
            "Revue de sprint hebdo",
            "Acces repository GitHub",
      ...
      ctaCopy:
        "Chaque projet commence par une conversation. Parlons de vos systemes actuels.",
...
const ar = {
  ...
  footer: {
    ...
    summary:
      "حلول الذكاء الاصطناعي، أنظمة التطوير، واستراتيجيات شراء الوسائط المصممة للأداء والوضوح.",
  ...
  home: {
    ...
    heroCopy:
      "نبني أتمتة ذكاء اصطناعي مخصصة، وهندسة منتجات عالية الأداء، وأنظمة وسائط آمنة للعلامة التجارية لزيادة إيراداتك بوضوح تام.",
    scrollLabel: "مرّر",
    expertiseLabel: "الخبرة",
    expertiseTitle: "ما نجيده بأفضل شكل",
    expertiseCopy:
      "نصنع تجارب رقمية تجمع بين التفكير الاستراتيجي والدقة الإبداعية.",
    serviceLabel: "الخدمة",
    ...
    bentoCards: [
      {
        title: "الهوية",
        copy: "أنظمة بصرية لعلامات طموحة.",
        span: "md:col-span-1",
      },
      {
        title: "الهندسة",
        copy: "منصات رقمية عالية الأداء وقابلة للتوسع.",
        span: "md:col-span-2",
      },
      {
        title: "التفاعل",
        copy: "سرد تفاعلي مبني على الكود.",
        span: "md:col-span-2",
      },
      {
        title: "التوسّع",
        copy: "هياكل نمو مدعومة بالبيانات.",
        span: "md:col-span-1",
      },
    ],
    clarity: [
    ...
    servicesSubtitle:
      "اختر مسارًا واحدًا أو اجمع المسارات الثلاثة في خطة تنفيذ واحدة.",
    serviceTracks: [
      {
    ...
    testimonialsSubtitle:
      "نعمل كفريق منتج داخلي، متوافقين مع النتائج ومسؤولين عن الأداء.",
    testimonials: [
      {
        quote:
          "الأتمتة غطّت تكلفتها خلال أول 45 يومًا. فريقهم يتحرك بعقلية استوديو منتج.",
        name: "أمينة باتيل",
        role: "COO، Meridian Commerce",
      },
      {
        quote:
          "أعاد Lightlab بناء قمع الاستحواذ لدينا فانخفض CAC وارتفع التحويل في نفس الوقت.",
        name: "جوردان لي",
        role: "VP Growth، Nova Health",
      },
    ],
    ...
    ctaCopy:
      "شارك أهدافك. سنصمم خطة تنفيذ تغطي الأتمتة والتطوير والنمو المدفوع.",
  ...
  services: {
    ...
    title: "محركات التوسع",
    subtitle:
      "مسارات خدمات متميزة لأتمتة الذكاء الاصطناعي، والتطوير عالي الأداء، وشراء الوسائط الآمن للعلامة التجارية.",
    overview: {
      ...
      ctaCopy:
        "سواء كان تدقيقًا للذكاء الاصطناعي أو إعادة بناء هندسية كاملة، نحن جاهزون.",
      ctaMetaLabel: "التوفر",
  ...
  caseStudies: {
    ...
    subtitle:
      "نماذج أعمال مختارة بنتائج قابلة للقياس في الأتمتة والمنتج والوسائط.",
    overview: {
      ...
      ctaCopy:
        "نختار عددًا محدودًا من المشاريع كل ربع لضمان التميز في التنفيذ.",
      ctaMetaLabel: "التوفر",
  ...
  about: {
    ...
    title: "منهج Lightlab",
    subtitle:
      "نحن شريك يجمع بين الاستراتيجية والتنفيذ لمساعدة العلامات التجارية الفاخرة ورواد التكنولوجيا على التوسع من خلال الذكاء الاصطناعي والهندسة المخصصة.",
    overview: {
      ...
      ctaTitle: "هل نتحدث؟",
      ctaCopy:
        "سواء كنت شريكًا مستقبليًا أو متعاونًا، بابنا مفتوح للعقول اللامعة.",
      ctaMetaLabel: "التوفر",
  ...
  projects: {
    ...
    titleLine2: "مثبتة",
    subtitle:
      "مجموعة مختارة من المشاريع عالية التأثير في أتمتة الذكاء الاصطناعي وتطوير المنتجات ونمو الإيرادات.",
    stats: {
      projects: "المشاريع",
      awards: "جوائز",
      years: "سنوات",
  ...
  contact: {
    ...
    title: "ابدأ البناء",
    subtitle:
      "شارك رؤيتك. سنقوم بهندسة الاستراتيجية وتجميع حزمة الأتمتة أو الهندسة المخصصة لتحقيق نمو تراكمي.",
